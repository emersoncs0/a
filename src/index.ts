...
const address = new Address("Minha Rua 67", "Meu Bairro", "Minha Cidade", "MA")
const customer1 = new Customer("Emerson Cardoso", "contato@gmail.com", new Date(2005, 4, 28), address);
